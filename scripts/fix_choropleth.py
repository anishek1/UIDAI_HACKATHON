"""
Fix choropleth code to not require kaleido for image export
"""
import json
...
# Find and fix the choropleth cell (the one with write_image)
for cell in nb['cells']:
    if cell['cell_type'] == 'code':
        source = ''.join(cell['source'])
        if 'write_image' in source and 'india_choropleth_ifi' in source:
            # Replace the problematic cell with fixed version
            cell['source'] = [
                "# ============================================\n",
            ...
            print("Fixed choropleth cell to skip image export")
            break
